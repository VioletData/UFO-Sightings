...
// // Then, select the summary element by class name
// var summary = d3.select("summary");

// filteredData.forEach(function(filteredDataInfo) {
//   console.log(filteredDataInfo);
//   var newrow = summary.append("tr");

//   Object.entries(filteredDataInfo).forEach(function([key, value]) {
//     console.log(key, value);
// //     // Append a cell to the row for each value
// //     // in the sighting object
...
// list.append("tr").text(`Date: ${datetime}`);
